...
public enum LocalizedMessage {
    ...
    ALIAS_NO_PERMISSIONS("AliasNoPermissions"),
    ALIAS_INVALID_ARGUMENTS_SINGULAR("AliasInvalidArgumentsSingular"),
    ALIAS_INVALID_ARGUMENTS_PLURAL("AliasInvalidArgumentsPlural"),
